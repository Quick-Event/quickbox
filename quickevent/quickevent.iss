...
#define QT_DIR "C:\app\qt5\5.4\mingw491_32"
#define MINGW_DIR "C:\app\qt5\Tools\mingw491_32"
...
#define BUILD_DIR "C:\proj\_build\quickbox-32-Release"
...
#endif
;SetupIconFile=.\divers\paralax\images\{#APP_NAME_LOWER}.ico
Compression=lzma
...
Source: {#QT_DIR}\bin\icudt53.dll; DestDir: {app}; Flags: ignoreversion
Source: {#QT_DIR}\bin\icuin53.dll; DestDir: {app}; Flags: ignoreversion
Source: {#QT_DIR}\bin\icuuc53.dll; DestDir: {app}; Flags: ignoreversion
