#ifndef QUICKEVENT_SI_PUNCHRECORD_H
#define QUICKEVENT_SI_PUNCHRECORD_H
...
class QUICKEVENT_DECL_EXPORT PunchRecord : public QVariantMap
{
private:
...
#endif // QUICKEVENT_SI_PUNCHRECORD_H
